...
class AddUserController extends Controller
{
        public function add_user(Request $request)
        {
            ...
            $company_id=$id;
            $comapny_admins=Company_Admins::where('_id',2)->value('total_employee');
            // dd($comapny_admins);
            $comapny_users=Company_user::where('company_id',$company_id)->count();
            ...
            if($comapny_admins >=  $comapny_users){
                $data = [
                    '_id' => $new_id,
