...
<div class="container-fluid p-0" style="background: linear-gradient(70deg, #FFC300,  #e5e276); padding: 50px 0;">
  <div class="row justify-content-center text-center">
    ...
    <div class="col-md-10">
      <form action="{{ route('shopper.create-order') }}" method="get" class="formXS">
        @csrf
        <div class="container searchdiv pb-5">
          <div class="row">
            <div class="col-md-10">
...
<div class="col-md-3">
            <a href="{{route('shopper.order_details',2)}}">
                <div class="testimonial-box1 d-flex flex-column align-items-center">
                    ...
                    <div class="testimonial-text">
                       <p><span class="productN producthoverE" data-toggle="tooltip" data-placement="top" data-original-title="title">
              
               </span>
               <span class="menu-product-new" style="margin-left: 20px;">$23</span>
               </p>
               </div>
                </div>
            </a>
                                                ...
                                                <div class="product-wrapper product-border mb-24">
                                                    <div class="product-img-3x">
                                                        <a href="#url" target="_blank">
                                                            <img src="{{URL::to('/')}}/public/upload/top_shops/logo/">
                                                        </a>
                                                    </div>
                                                    <div class="product-content-4 text-center">
                                                        <h4><a href="url" target="_blank">product name</a></h4>
                                                    </div>
                                                </div>
                                            </div>
