                                    ...
                                    <input type="hidden" value="{{$data->trip_id}}" name="trip_id">
                                        ...
                                        <dt class="col-sm-3">Product Price</dt>
                                            ...
                                            <dd class="col-sm-9" >
                                                <!-- <span id="changed_traveller_re_tr">{{$data->traveller_reward}}</span>  -->
                                                <!-- <span id="">{{$data->traveller_reward}}</span>  -->
                                                <!-- <input type="text" placeholder="Message" class="form-group form-control"id="change_travel_fee" name="change_travel_fee" value=""> -->
                                                <a href="javascript:void(0)" id="show-details" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-url="{{ $data->match_buyer_id }}">
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <input type="hidden" name="_token" id="csrf" value="{{Session::token()}}">
                                                           ...
                                                           <input type="text" placeholder="Enter Message" id="message" name="message"/>
                                                            ...
                                                            <button type="button" id="butsave" class="btn btn-primary">Sand</button>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    </div>
