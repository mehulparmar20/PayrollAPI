                        ...
                        <div class="card">
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <form method="post" action="{{ route('traveller.store_offer',['id'=>$data->matched_id]) }}">
                                        @csrf
                                    ...
                                    <input type="hidden" value="{{$data->trip_id}}" name="trip_id">
                                        ...
                                        <dt class="col-sm-3">Product Price</dt>
                                            ...
                                            <dd class="col-sm-9" >
                                                ...
                                                <input type="number" placeholder="Offer" class="form-group" onkeyup="chnagePriceTraveller('traveller_fee','{{$data->Buy4me_fee}}','{{$data->payment}}','{{$data->traveller_reward}}')" id="change_travel_fee" name="change_travel_fee" value="{{$data->counter_traveller_reward}}">
                                            </dd>
                                            <dt class="col-sm-3">Message</dt>
                                            <dd class="col-sm-9" >
                                                    <!-- <a href="javascript:void(0)" id="show-user" data-url="{{ $data->match_buyer_id }}" class="btn btn-info">Show</a> -->

                                                <div>
                                                    <a href="javascript:void(0)" id="show-user" data-url="{{ $data->match_buyer_id }}">
                                                        <button type="button" class="btn btn-outline-custom11">
                                                            show
                                                        </button>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <input type="hidden" placeholder="Enter Message" id="order_id" name="order_id" value="{{$data->match_order_id}}"/>
                                                    <input type="hidden" placeholder="Enter Message" id="buyer_id" name="buyer_id" value="{{$data->match_buyer_id}}"/>
                                                    <input type="hidden" placeholder="Enter Message" id="traveller_id" name="traveller_id" value="{{$data->match_traveller_id}}"/>
                                                    ...
                                                    <input type="text" placeholder="Enter Message" id="message" name="message"/>
                                                        <!-- <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button> -->
                                                           ...
                                                           <!-- <button type="button" id="butsave" class="btn btn-primary">Send</button> -->
                                                                <button type="button" id="butsave" class="btn btn-outline-custom11">
                                                                    Send
                                                                </button>
                                                </div>
                                                    <!-- <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button> -->
                                        ...
                                        <div class="d-flex gap-3 mt-3">
                                            ...
                                            <div class="menu-custbtn-area text-center mt-1" >
                                                ...
                                                <!-- <a  href="{{route('stripeIdentity.index')}}" class="menu-custbtn" style="border:none;width: 111px; padding: 3px 15px 3px 15px;">Confirm</a> -->

                                                <a  href="{{route('stripe.shopper',['match_id'=>$data->matched_id,'total'=>$data->total,'currency'=>$data->currency])}}" class="menu-custbtn" style="border:none;width: 111px; padding: 3px 15px 3px 15px;">Confirm</a>    
                                            </div>
                                        </div>
                                    </form>
                                </div>
