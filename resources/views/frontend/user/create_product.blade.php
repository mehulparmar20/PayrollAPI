								...
								<div id="test-l-1" role="tabpanel" class="bs-stepper-pane active dstepper-block" aria-labelledby="stepper1trigger1" bis_skin_checked="1">
									<div class="row g-3" bis_skin_checked="1">
										...
										<!-- <div class="col-12 col-lg-4" bis_skin_checked="1">
											...
											<input type="text" class="form-control textFx" id="order_productName" name="product_name"  value ="{{$title}}" placeholder="Enter Product Name" onkeyup="summery_vali('product_name',{{$buy4meFee}},{{$paymentPro}},{{$travel_tax}})">
										</div> -->
										<div class="col-12 col-lg-4" bis_skin_checked="1">
										<label for="LastName" class="form-label labelX">Product Name <span style="color:red">*</span></label>
										...
										<!-- <div class="col-12 col-lg-4" bis_skin_checked="1">
											<label for="InputEmail" class="form-label labelX">Price<span style="color:red">*</span></label>
											<input name="product_price" class="form-control textFx" type="text" value="{{$price}}" placeholder="Enter Price" onkeyup="summery_vali('product_price',{{$buy4meFee}},{{$paymentPro}},{{$travel_tax}})" id="order_product_price">
										</div> -->
										<div class="col-12 col-lg-4" bis_skin_checked="1">
										<label for="InputEmail" class="form-label labelX">Price<span style="color:red">*</span></label>
...
// function updateCurrency(buy4meFee, paymentPro, travelTax) {
...
//     } else if (currencySelect.value === "2") {
//         var originalValue = priceInput.getAttribute("data-original-value");
//         originalValue = "$" + originalValue.replace(/[^\d.]/g, '');
//         originalValue = originalValue.replace(/\.\d*$/, '');
