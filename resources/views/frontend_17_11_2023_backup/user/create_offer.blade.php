                        ...
                        <div class="row g-0">
                            <div class="col-md-4 border-end">
                                ...
                                <a href="{{URL::to('/')}}/public/product_img/{{$i}}">
                                    <img src="{{URL::to('/')}}/public/product_img/{{$i}}" alt="" class="img-fluid">
                                </a>
                            
                            </div>
                            <div class="col-md-8">
                                <form method="post" action="{{route('shopper.create_offer',['id'=>$data->id])}}">
                                    @csrf
                                    <input type="hidden" value="{{ request()->get('matched_id') }}" name="matched_id">
                                    <div class="card-body">
                                    ...
                                    <input type="hidden" id="order_id" value="{{$data->id}}" name="order_id">
                                    <input type="hidden" id="tripid" value="{{$data->trip_id}}" name="tripid">
                                    <input type="hidden" id="buyerid" value="{{$data->buyer_id}}" name="buyerid"> 
                                    ...
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-9">{{$data->toCIty}} </dd>
                                        ...
                                        <dt class="col-sm-3">Message</dt>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <input type="hidden" placeholder="Enter Message" id="buyer_id" name="buyer_id" value="{{$data->buyer_id}}"/>
                                                    <input type="hidden" placeholder="Enter Message" id="traveller_id" name="traveller_id" value="{{$data->traveller_id_trip}}"/>
                                                    <input type="hidden" placeholder="Enter Message" id="order_id" name="order_id" value="{{$data->id}}"/>
                                    ...
                                    <?php echo $data->product_price + $data->traveller_reward ?>      
                                     </span>
