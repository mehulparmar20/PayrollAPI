   ...
   ->get();
    ...
    $quewryReceived = clone $general_query; // Clone the query for the second count
    ...
    $quewryReceived->where('matched_orders.buyer_id', '=',  Auth::user()->id)
        ->whereNull('matched_orders.deleted_at')
        ->where('matched_orders.status', '=', '3');
