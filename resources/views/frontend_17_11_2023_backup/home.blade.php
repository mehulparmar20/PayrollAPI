              ...
              <a href="#">
                <div class="testimonial-box1 d-flex flex-column align-items-center">
                    <div class="testimonial-image text-center">
                        <img src="https://b4m.veravalonline.com/b4m/public/upload/product_img/url(assets/img/bg/13.jpg)" alt="Testimonial Image" class="img-fluid" style="max-height: 200px;">
                    </div>
                    <div class="testimonial-text">
                       <p><span class="productN producthoverE" data-toggle="tooltip" data-placement="top" data-original-title="product1">
                
               </span>
               <span class="menu-product-new" style="margin-left: 20px;">$25</span>
               </p>
               </div>
                </div>
            </a>
