  ...
  <div class="container-fluid custmizeMM">
    ...
    <div class="container-fluid">
                  <div class="row">
                    ...
                    <!-- Repeat this block for each trip in your loop -->
                    @foreach ($trips as $row)
                    <div class="col-md-3 mb-4"> <!-- col-md-3 will create four columns in a row on medium-sized screens -->
                      <div class="card h-100">
                        <div class="card-body">
                          <h5 class="card-title text-center mb-4">Upcoming Trip</h5>
                          <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                              <strong>Date:</strong>&nbsp;{{ date("M d, Y", strtotime($row->travel_date)) }}
                            </li>
                            <li class="list-group-item">
                              <strong>From:</strong>&nbsp;{{$row->origincountry}}
                            </li>
                            <li class="list-group-item">
                              <strong>To:</strong>&nbsp;{{$row['destination']['destination_country']}}, {{$row['destination']['destination_city']}}
                            </li>
                            <li class="list-group-item">
                              <strong>Departure:</strong>&nbsp;{{ date("M d, Y", strtotime($row->travel_date)) }}
                            </li>
                          </ul>
                          <div class="col-md border bg-white p-3">
                            <div class="menu-custbtn-area text-center">
                              <a class="menu-custbtn" href="{{route('traveller.matched_trip',[$row,'from'=>'trip'])}}">Check Offer</a>
                            </div>
                          </div>
                        </div>
