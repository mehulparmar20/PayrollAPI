  ...
  <body>
    ...
    <div class="menu-btnX-area text-center mt-1" style="display: inline-block;">
                        <a class="menu-btnX btn-hover" href="#">Matched Trips</a>
                    </div>
</div>
<?php
    $matchedorder = 0;
...
?>
              ...
              <div class="section-title-3 text-center mb-40">
                ...
                <div class="section-title-3 text-center mb-15 custmizeMargin" role="tablist">
                    <div class="StatusXX"><a class="active menuHeader tab-link" href="#matchTrip_order" data-bs-toggle="tab" role="tab">Matched order1({{ $matchedorder}})</a></div>


                    <div class="StatusXX"><a class="menuHeader tab-link" href="#matchTrip_requested" data-bs-toggle="tab" role="tab"> Requested ({{$requested}}) </a></div>
                        
                    <div class="StatusXX"><a class="menuHeader tab-link" href="#matchTrip_IncomingRe" data-bs-toggle="tab" role="tab">Counter Request({{$countrequested}}) </a></div>
...
<div class="tab-pane fade" id="matchTrip_incomingRe" role="tabpanel">
  ...
  <div class="container-fluid">
      ...
      @if(isset($row['MatchedTrip']) && $row['MatchedTrip']['status'] == 2)
