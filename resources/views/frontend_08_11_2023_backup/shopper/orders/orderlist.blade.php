                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                ...
                                <div class="card-body card-body-shadow">
                                    ...
                                    <p class="card-text cardP"><span class="countryX">From &nbsp:&nbsp</span>{{$row->origincountry}}</p>
                                    ...
                                    <p class="card-text cardP"><span>by {{ date("M d, Y", strtotime($row->deliverd_date))}},</p>
                                    <div class="details-price">
                                        <h4 class="card-text productN" style="display: inline; margin-right: 6px; font-size:13px;">
                                    ...
                                    <div class="details-price boxBorder">
                                        <h4 class="card-text productN" style="display: inline; margin-right: 4px; font-size:13px;">
                                            <a href="#"><span>Price &nbsp:&nbsp <span class="" style="font-size: 13px;">{{($row->currency == 'USD') ? '$' : 'INR'}}{{$row->product_price}}</span></span></a>
                                        </h4>
                                        <h4 class="card-text productN" style="display: inline; font-size:13px;"><a href="#"><span>Reward &nbsp:&nbsp<span class="details-price1">{{($row->currency == 'USD') ? '$' : 'INR'}} {{$row->traveller_reward}}</span></span></a></h4>
                                    </div>
