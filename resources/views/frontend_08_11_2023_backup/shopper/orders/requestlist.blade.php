                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text cardP"><span class="countryX77">Traveller &nbsp:&nbsp
                                        </span> <span class="fontStyling">{{ $row->first_name }} {{ $row->last_name }}</span></p>
                                    <p class="card-text cardP"><span class="countryX77">Trip Date &nbsp:&nbsp
                                        </span> <span class="fontStyling"> {{ $row->travel_date }} </span></p>
                                    <p class="card-text cardP"><span class="countryX77">From &nbsp:&nbsp </span>{{ $row->origin_country }}</p>
                                    <!-- <p class="card-text cardP"><span><span class="countryX">To:-</span>{{ $row->destination_city }}</p> -->
                                    <p class="card-text cardP"><span><span class="countryX77">To &nbsp:&nbsp </span> {{ $row->destination_c }},</p>
                                    <p class="card-text cardP"><span>by
                                            {{ date('M d, Y', strtotime($row->deliverd_date)) }}</p>
                                    <div class="details-price">
                                        <h4 class="card-text productN22" style="display: inline; margin-right: 6px;">
                                            <a href="#"><span>Quantity&nbsp:&nbsp <span class="details-price1">{{ $row->quantity }}</span></span></a>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="details-price">
                                        <h4 class="card-text productN22" style="display: inline; margin-right: 6px;">
                                            <a href="#"><span>Product Price: <span class="details-price1">{{ $row->currency == 'USD' ? '$' : 'INR' }}{{ $row->product_price }}</span></span></a>
                                        </h4>
                                        <h4 class="card-text productN22" style="display: inline;"><a href="#"><span>Reward: <span class="details-price1">{{ $row->currency == 'USD' ? '$' : 'INR' }}
                                                        {{ $row->traveller_reward }}</span></span></a></h4>
                                        <div>


                                            <div class="details-price">
                                                <h4 class="card-text productN22" style="display: inline; margin-right: 6px;">
                                                    <a href="#"><span>Counter Price: <span class="details-price1">{{ $row->currency == 'USD' ? '$' : 'INR' }}{{ $row->counter_product_price }}</span></span></a>
                                                </h4>
                                                <h4 class="card-text productN22" style="display: inline;"><a href="#"><span>Reward: <span class="details-price1">{{ $row->currency == 'USD' ? '$' : 'INR' }}
                                                                {{ $row->counter_traveller_reward }}</span></span></a>
                                                </h4>
                                            </div>
                                        </div>
